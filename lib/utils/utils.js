...
function toEthersBN(val) {
    return ethers_1.BigNumber.from(val.toFixed());
}
 ...
 * @returns
 */
var confirmTransaction = function (provider, txHash, timeout) {
    if (timeout === void 0) { timeout = 5 * 60 * 1000; }
    return __awaiter(void 0, void 0, void 0, function () {
        var receipt;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, provider.waitForTransaction(txHash, undefined, timeout)];
                case 1:
                    receipt = _a.sent();
                    return [2 /*return*/];
            }
...
var orderFromJSON = function (order) {
    ...
    var fromJSON = {
        ...
        quantity: new utils_1.BigNumber(order.quantity || 1),
        ...
        makerRelayerFee: new utils_1.BigNumber(order.maker_relayer_fee),
        takerRelayerFee: new utils_1.BigNumber(order.taker_relayer_fee),
        makerProtocolFee: new utils_1.BigNumber(order.maker_protocol_fee),
        takerProtocolFee: new utils_1.BigNumber(order.taker_protocol_fee),
        makerReferrerFee: new utils_1.BigNumber(order.maker_referrer_fee || 0),
        ...
        basePrice: new utils_1.BigNumber(order.base_price),
        extra: new utils_1.BigNumber(order.extra),
        currentBounty: new utils_1.BigNumber(order.current_bounty || 0),
        currentPrice: new utils_1.BigNumber(order.current_price || 0),
        createdTime: new utils_1.BigNumber(Math.round(createdDate.getTime() / 1000)),
        listingTime: new utils_1.BigNumber(order.listing_time),
        expirationTime: new utils_1.BigNumber(order.expiration_time),
 ...
 */
function personalSignAsync(signer, message) {
    return __awaiter(this, void 0, void 0, function () {
        var signature;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, signer.signMessage(ethers_1.ethers.utils.arrayify(message))];
                case 1:
                    signature = _a.sent();
                    return [2 /*return*/, parseSignatureHex(signature)];
            }
        });
    });
}
 ...
 */
function isContractAddress(provider, address) {
    return __awaiter(this, void 0, void 0, function () {
        var code;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function makeBigNumber(arg) {
    ...
    arg = arg.toString();
    return new utils_1.BigNumber(arg);
}
 ...
 * @param onError callback when user denies transaction
 */
function sendRawTransaction(signer, _a, onError) {
    var from = _a.from, to = _a.to, data = _a.data, gasPrice = _a.gasPrice, _b = _a.value, value = _b === void 0 ? 0 : _b;
    return __awaiter(this, void 0, void 0, function () {
        var txData, txRes, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    txData = __assign(__assign({ from: from, to: to, data: data }, (gasPrice == null
                        ? {}
                        : { gasPrice: toEthersBN(new utils_1.BigNumber(gasPrice)) })), (value == 0 || value == null
                        ? {}
                        : { value: toEthersBN(new utils_1.BigNumber(value)) }));
                    return [4 /*yield*/, signer.sendTransaction(txData)];
                case 1:
                    txRes = _c.sent();
                    return [2 /*return*/, txRes.hash]; // this is in line with previous behaviour which was to return the transaction hash
                case 2:
                    error_1 = _c.sent();
                    onError(error_1);
                    throw error_1;
 ...
 * @param onError callback when user denies transaction
 */
function rawCall(provider, _a, onError) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, provider.call({ from: from, to: to, data: data })];
                case 1:
                    result = _b.sent();
 ...
 */
function estimateGas(provider, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    bn = toEthersBN(new utils_1.BigNumber(value));
                ...
                case 1:
                    amount = _c.sent();
                    return [2 /*return*/, toBigNumberJS(amount)];
            }
        });
    });
}
 ...
 * @param web3 Web3 instance
 */
function getCurrentGasPrice(provider) {
    return __awaiter(this, void 0, void 0, function () {
        var meanGas;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    meanGas = _a.sent();
                    return [2 /*return*/, toBigNumberJS(meanGas)];
            }
        });
    });
}
 ...
 */
function getTransferFeeSettings(provider, _a) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    feeContract = new ethers_1.ethers.Contract(asset.tokenAddress, contracts_1.ERC1155, provider);
                    return [4 /*yield*/, feeContract.functions.transferSettings(asset.tokenId, {
                            from: accountAddress,
                        })];
                case 1:
                    params = _b.sent();
...
function estimateCurrentPrice(order, secondsToBacktrack, shouldRoundUp) {
    ...
    var now = new utils_1.BigNumber(Math.round(Date.now() / 1000)).minus(secondsToBacktrack);
    basePrice = new utils_1.BigNumber(basePrice);
    listingTime = new utils_1.BigNumber(listingTime);
    expirationTime = new utils_1.BigNumber(expirationTime);
    extra = new utils_1.BigNumber(extra);
    ...
    return shouldRoundUp
        ? exactPrice.integerValue(utils_1.BigNumber.ROUND_CEIL)
        : exactPrice;
}
...
function getWyvernAsset(schema, asset, quantity) {
    if (quantity === void 0) { quantity = new utils_1.BigNumber(1); }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    results = (_a.sent()).filter(function (res) { return res.status === "fulfilled"; });
                    return [2 /*return*/, _.compact(results.map(function (res) { return res.value; }))[0]];
            }
        });
    });
}
