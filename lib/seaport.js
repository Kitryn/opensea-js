...
var OpenSeaPort = /** @class */ (function () {
     ...
     *  information
     */
    function OpenSeaPort(signer, apiConfig, logger) {
        if (apiConfig === void 0) { apiConfig = {}; }
        // Extra gwei to add to the mean gas price when making transactions
        this.gasPriceAddition = utils_1.toBigNumberJS(ethers_1.ethers.utils.parseUnits("2", "gwei"));
        // Multiply gas estimate by this factor when making transactions
        this.gasIncreaseFactor = constants_1.DEFAULT_GAS_INCREASE_FACTOR; // TODO: is this required
        // API config
        ...
        // WyvernJS config
        this._wyvernProtocol = new wyvern_js_1.WyvernProtocol(this.signer, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        gasPrice = _b.sent();
                        return [4 /*yield*/, utils_1.sendRawTransaction(this.signer, {
                                from: accountAddress,
    ...
    OpenSeaPort.prototype.approveSemiOrNonFungibleToken = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, contractInstance, approvalAllCheck, isApprovedForAll, gasPrice, data, txHash, error_6, approvalOneCheck, isApprovedForOne, gasPrice, data, txHash, error_7;
            var _this = this;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        schema = this._getSchema(schemaName);
                        return [4 /*yield*/, new ethers_1.ethers.Contract(tokenAddress, tokenAbi, this.signer)];
                    case 1:
                    ...
                    case 3:
                        approvalAllCheck = function () { return __awaiter(_this, void 0, void 0, function () {
                            var data, isApprovedForAllRaw;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        data = contractInstance.interface.encodeFunctionData("isApprovedForAll", [accountAddress, proxyAddress]);
                                        return [4 /*yield*/, utils_1.rawCall(this.provider, {
                                                from: accountAddress,
                    ...
                    case 6:
                        gasPrice = _e.sent();
                        data = contractInstance.interface.encodeFunctionData("setApprovalForAll", [proxyAddress, true]);
                        return [4 /*yield*/, utils_1.sendRawTransaction(this.signer, {
                                from: accountAddress,
                                to: contractInstance.address,
                                data: data,
                        ...
                        approvalOneCheck = function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        return [4 /*yield*/, contractInstance.getApproved(tokenId)];
                                    case 1:
                                    ...
                                    case 3:
                                        ...
                                        return [4 /*yield*/, utils_1.getNonCompliantApprovalAddress(contractInstance, tokenId, accountAddress)];
                                    case 4:
                                        approvedAddr = _a.sent();
                                        if (approvedAddr != null && approvedAddr == proxyAddress) {
                    ...
                    case 13:
                        gasPrice = _e.sent();
                        data = contractInstance.interface.encodeFunctionData("approve", [
                            proxyAddress,
                            tokenId,
                        ]);
                        return [4 /*yield*/, utils_1.sendRawTransaction(this.signer, {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!(minimumAmount.gt(0) && hasOldApproveMethod)) return [3 /*break*/, 3];
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [2 /*return*/, newlyApprovedAmount.gte(minimumAmount)];
                                    }
                                });
                            }); })];
                    case 6:
    ...
    OpenSeaPort.prototype.getCurrentPrice = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.calculateCurrentPrice_.callAsync([
                            order.exchange,
                            order.maker,
                            order.taker,
                            order.feeRecipient,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, gas != null && gas.gt(0)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        _c.trys.push([3, 5, , 8]);
                        return [4 /*yield*/, utils_1.estimateGas(this._getClientsForRead(retries).provider, {
                                from: from,
                                to: abi.target,
                                data: data,
                            })];
    ...
    OpenSeaPort.prototype.transferAll = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        toAddress = utils_1.validateAndFormatWalletAddress(toAddress);
    ...
    OpenSeaPort.prototype.getAssetBalance = function (_a, retries) {
        ...
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, abi, contract, inputValues, count, _b, _c, _d, abi, contract, inputValues, owner;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        schema = this._getSchema(asset.schemaName);
                        ...
                        contract = new ethers_1.ethers.Contract(abi.target, [abi], this._getClientsForRead(retries).provider);
                        inputValues = abi.inputs
                            .filter(function (x) { return x.value !== undefined; })
                            .map(function (x) { return x.value; });
                        _b = utils_1.toBigNumberJS;
                        _d = (_c = ethers_1.BigNumber).from;
                        return [4 /*yield*/, contract[abi.name].apply(contract, __spreadArray([accountAddress], inputValues))];
                    case 1:
                        count = _b.apply(void 0, [_d.apply(_c, [_e.sent()])]);
                        if (count !== undefined) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, contract[abi.name].apply(contract, inputValues)];
                    case 3:
                        owner = _e.sent();
                        if (owner) {
                            return [2 /*return*/, owner.toLowerCase() == accountAddress.toLowerCase()
                                    ? new utils_2.BigNumber(1)
                                    : new utils_2.BigNumber(0)];
                        }
                        return [3 /*break*/, 5];
                    case 4: 
    ...
    OpenSeaPort.prototype.computeFees = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var openseaBuyerFeeBasisPoints, openseaSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, transferFee, transferFeeTokenAddress, maxTotalBountyBPS, _asset, result, error_10, sellerBountyBasisPoints, bountyTooLarge, errorMessage;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, utils_1.getTransferFeeSettings(this.provider, {
                                asset: _asset,
                                accountAddress: accountAddress,
                            })];
                    case 2:
    ...
    OpenSeaPort.prototype.validateAndPostOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.hashOrder_.callAsync([
                            order.exchange,
                            order.maker,
                            order.taker,
                            order.feeRecipient,
    ...
    OpenSeaPort.prototype._computeGasPrice = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils_1.getCurrentGasPrice(this.provider)];
                    case 1:
                        meanGas = _a.sent();
    ...
    OpenSeaPort.prototype._correctGasAmount = function (estimation) {
        ...
        return estimation
            ...
            .integerValue(utils_2.BigNumber.ROUND_CEIL);
    };
    /**
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _d.sent();
                        _c = schema_1.encodeAtomicizedTransfer(schemaNames.map(function (name) { return _this._getSchema(name); }), wyAssets, fromAddress, toAddress, this._wyvernProtocol, this._networkName), calldata = _c.calldata, target = _c.target;
                        return [2 /*return*/, utils_1.estimateGas(this.provider, {
                                from: fromAddress,
                                to: proxyAddress,
                                data: schema_1.encodeProxyCall(target, types_1.HowToCall.DelegateCall, calldata),
                            })];
    ...
    OpenSeaPort.prototype._initializeProxy = function (accountAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var gasPrice, txnData, transactionResponse, proxyAddress;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._wyvernProtocol.wyvernProxyRegistry.registerProxy.sendTransactionAsync(__assign(__assign({}, txnData), { gasPrice: gasPrice }))];
                    case 2:
                        transactionResponse = _a.sent();
                        return [4 /*yield*/, this._confirmTransaction(transactionResponse.hash, types_1.EventType.InitializeAccount, "Initializing proxy for account", function () { return __awaiter(_this, void 0, void 0, function () {
                                var polledProxy;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, openSeaAsset, taker, _d, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, _e, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _f, target, calldata, replacementPattern, _g, basePrice, extra, paymentToken, times, _asset, _h, staticTarget, staticExtradata;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.api.getAsset({
    ...
    OpenSeaPort.prototype._getStaticCallTargetAndExtraData = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var isCheezeWizards, isDecentralandEstate, isMainnet, cheezeWizardsBasicTournamentAddress, cheezeWizardsBasicTournmentInstance, _data, wizardFingerprint, decentralandEstateAddress, decentralandEstateInstance, _data, estateFingerprint;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        isCheezeWizards = [
                        ...
                        cheezeWizardsBasicTournmentInstance = new ethers_1.ethers.Contract(cheezeWizardsBasicTournamentAddress, contracts_1.CheezeWizardsBasicTournament, this.provider // readonly?
                        );
                        _data = cheezeWizardsBasicTournmentInstance.interface.encodeFunctionData("wizardFingerprint", [asset.tokenId]);
                        return [4 /*yield*/, utils_1.rawCall(this.provider, {
                    ...
                    case 2:
                        ...
                        decentralandEstateInstance = new ethers_1.ethers.Contract(decentralandEstateAddress, contracts_1.DecentralandEstates, this.provider // read only
                        );
                        _data = decentralandEstateInstance.interface.encodeFunctionData("getFingerprint", [asset.tokenId]);
                        return [4 /*yield*/, utils_1.rawCall(this.provider, {
    ...
    OpenSeaPort.prototype._makeMatchingOrder = function (_a) {
        ...
        accountAddress = utils_1.validateAndFormatWalletAddress(accountAddress);
        recipientAddress = utils_1.validateAndFormatWalletAddress(recipientAddress);
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 7:
                        error_12 = _d.sent();
                        if (retries <= 0) {
                            throw new Error("Error matching this listing: " + error_12.message + ". Please contact the maker or try again later!");
                        }
                        return [4 /*yield*/, utils_1.delay(500)];
                    case 8:
                        _d.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.validateOrderParameters_.callAsync([
                            order.exchange,
                            order.maker,
                            order.taker,
                            order.feeRecipient,
    ...
    OpenSeaPort.prototype._validateOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.validateOrder_.callAsync([
                            order.exchange,
                            order.maker,
                            order.taker,
                            order.feeRecipient,
                ...
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, Promise.all(wyAssets.map(function (wyAsset, i) { return __awaiter(_this, void 0, void 0, function () {
                                var schemaName, isOwner, error_13, minAmount, _a, wyNFTAsset, wyFTAsset;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        _b.sent();
                        _b.label = 5;
                    case 5: return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.validateOrderParameters_.callAsync([
                            order.exchange,
                            order.maker,
                            order.taker,
                            order.feeRecipient,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        minAmount = new utils_2.BigNumber("quantity" in wyAsset ? wyAsset.quantity : 1);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        basePrice = isEther
                            ? utils_1.makeBigNumber(ethers_1.ethers.utils.parseEther(startAmount.toString())).integerValue(utils_2.BigNumber.ROUND_CEIL)
                            : wyvern_js_1.WyvernProtocol.toBaseUnitAmount(utils_1.makeBigNumber(startAmount), token.decimals);
                        extra = isEther
                            ? utils_1.makeBigNumber(ethers_1.ethers.utils.parseEther(priceDiff.toString())).integerValue(utils_2.BigNumber.ROUND_CEIL)
                        ...
                        reservePrice = englishAuctionReservePrice
                            ? isEther
                                ? utils_1.makeBigNumber(ethers_1.ethers.utils.parseEther(englishAuctionReservePrice.toString())).integerValue(utils_2.BigNumber.ROUND_CEIL)
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? constants_1.NULL_BLOCK_HASH : _b;
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, txResponse, txnData, args, gasEstimate, _c, error_14, error_15;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, this._getClientsForRead().wyvernProtocol.wyvernExchange.atomicMatch_.estimateGasAsync(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], txnData)];
                    case 9:
                        gasEstimate = _d.sent();
                        _c = txnData;
                        return [4 /*yield*/, this._computeGasPrice()];
                    ...
                    case 11:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The OpenSea devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"" + error_14.message.substr(0, debugging_1.MAX_ERROR_LENGTH) + "...\"");
                    case 12:
                    ...
                    case 14:
                        ...
                        throw new Error("Failed to authorize transaction: \"" + (error_15.message ? error_15.message : "user denied") + "...\"");
                    case 15: return [2 /*return*/, txResponse.hash];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        maxPrice = utils_2.BigNumber.max(currentPrice, estimatedPrice);
                        feePercentage = sell.takerRelayerFee.div(constants_1.INVERSE_BASIS_POINT);
                        fee = feePercentage.times(maxPrice);
                        return [2 /*return*/, fee.plus(maxPrice).integerValue(utils_2.BigNumber.ROUND_CEIL)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_1.isContractAddress(this.provider, signerAddress)];
                    case 1:
                    ...
                    case 3:
                        ...
                        _a.sent();
                        return [2 /*return*/, null];
                    case 4: return [4 /*yield*/, utils_1.personalSignAsync(this.signer, message)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, utils_1.confirmTransaction(this.provider, transactionHash)];
                    case 5:
                        _a.sent();
